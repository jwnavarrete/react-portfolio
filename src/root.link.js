...
export const LAST_NAME = 'Navarrete';
export const ADDRESS = 'Ecuador, Duran'
export const EMAIL_ID = 'jwnavarretez@gmail.com';
export const TWITTER_ID = 'Vk_javiya';
export const FRONT_PAGE_NAME = 'John Navarrete';
