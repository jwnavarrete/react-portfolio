              ...
              <div className='flex flex-col overflow-auto  space-y-3 my-3 mx-1 w-full md:w-5/12 '>
                ...
                <div className='w-auto flex space-x-5 relative '>
                  <a href={project.github} target='_blank' rel='noreferrer'>
                    <img src='../assets/images/icons/github.svg' alt='link to github page' width='24px' height='24px' />
                  </a>
                  <a href={project.link} target='_blank' rel='noreferrer'>
                    <img src='../assets/images/icons/external-link.svg' alt='link to live website' width='24px' height='24px' />
                  </a>
                </div>
              </div>
            </article>
